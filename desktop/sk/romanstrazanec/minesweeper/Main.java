        ...
        if (me.getX() - 7 > fld.getX() && me.getX() < fld.getWidth() + 37 &&
            ...
            if (me.getButton() == 1) {
                ...
                if (fld.getDead()) {
                    ...
                    if (fld.getWidthofField() == 9 && fld.getHeightofField() == 9 && fld.getBombs() == 10)
                        title = "statseasy.dat";
                    if (fld.getWidthofField() == 16 && fld.getHeightofField() == 16 && fld.getBombs() == 40)
                        title = "statsmedium.dat";
                    if (fld.getWidthofField() == 30 && fld.getHeightofField() == 16 && fld.getBombs() == 99)
                        title = "statshard.dat";
                    if (title != null) {
